...
class TempViewer:
    def update(
        ...
        None
    ):  # Alert method that is invoked when then notify() method in a concrete subject is invoked
        logging.info(
            "Temperature Viewer: %s has Temperature %s", subject._name, subject._temp
        )
